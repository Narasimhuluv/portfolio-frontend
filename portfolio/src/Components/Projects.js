      ...
      <div className="flex justify_between flex_wrap">
        <article className="flex_28 ">
          ...
          <p>
            ...
            get unlimited access. Your membership fee supports Casey Botticello
            and the voices you want to hear more from.
          </p>
        ...
        <article className="flex_28 ">
          ...
          <p>
            ...
            most popular repos for a variety of languages as well as battle two
            Github users
          </p>
          <ul className="flex flex_wrap justify_center tag_names">
            <li>ReactJs</li>
        ...
        <article className="flex_28 ">
          ...
          <p>
            ...
            is data Fetch by using API and it will take us to the Individual
            movies or series of details when we click on specific movie or
            series.
          </p>
          <ul className="flex flex_wrap justify_center tag_names">
            <li>ReactJs</li>
